...
<head>
    ...
    <title>Trinity Cafe - Coffee Menu</title>
    ...
    <header class="bg-white shadow-md sticky top-0 z-50">
        <nav class="container mx-auto px-6 py-4 flex justify-between items-center">
            <a href="home.html" class="flex items-center space-x-2">
                <!-- 
                  PASTE YOUR LOGO IMAGE 'src' BELOW 
                -->
            ...
            if ($result->num_rows > 0) {
              ...
              while($row = $result->fetch_assoc()) {
                ...
                echo '<img src="' . htmlspecialchars($row['image_url']) . '" 
                           ...
                           onerror="this.src=\'https://placehold.co/400x300/A1887F/FFFFFF?text=Image+Missing\'; this.onerror=null;">';
              ...
              echo "<p class='text-lg text-gray-700'>No coffee products found.</p>";
            }
