...
<head>
    ...
    <title>Customer Account - Trinity Cafe</title>
...
<body class="bg-blue-50 text-gray-800">
    ...
    <main class="container mx-auto p-6 mt-8 flex justify-center">
        ...
        <div class="bg-white rounded-lg shadow-lg p-10 w-full max-w-md">
            <h1 class="text-3xl font-bold text-center text-gray-800 mb-8">Customer Login</h1>
            ...
            <form action="login_logic.php" method="POST">
                ...
                <p class="text-center text-gray-600 mt-4">
                    Don't have an account? <a href="register.php" class="text-yellow-700 hover:underline">Sign up</a>
                </D>
            </form>
        </div>
