...
<head>
    ...
    <title>Trinity Cafe - Order Complete</title>
...
<body class="bg-blue-50 text-gray-800">
    ...
    <main class="container mx-auto p-6 mt-8 flex justify-center">
        ...
        <div class="bg-white rounded-lg shadow-lg p-10 w-full max-w-2xl text-center">
            ...
            <a href="home.html" 
               class="block w-full max-w-xs mx-auto text-center bg-yellow-600 text-white text-lg font-semibold px-10 py-3 rounded-lg hover:bg-yellow-700">
                &larr; Back to Home
            </a>
